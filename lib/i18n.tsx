...
const translations: Record<Lang, Record<string, any>> = {
  en: {
    ...
    billing: {
      ...
      description:
        "We'll email a receipt to the address below. Turn on invoice to add address details.",
      fullName: "Name",
  ...
  de: {
    ...
    billing: {
      ...
      description:
        "Wir senden eine Quittung an die unten angegebene Adresse. Aktivieren Sie die Rechnung, um Adressdetails hinzuzufügen.",
      fullName: "Name",
      ...
      phonePlaceholder: "+49 123 456789",
      invoiceToggleTitle: "Detail-Rechnung benötigt?",
      invoiceToggleDescription:
        "Fügen Sie Adressdetails für eine vollständige Rechnung hinzu.",
    ...
    paymentAuthorized: {
      ...
      title: "Alles bereit",
      description:
        "Der Ladevorgang beginnt in Kürze. Sie erhalten nach der Sitzung eine Quittung per E-Mail.",
